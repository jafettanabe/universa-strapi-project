...
export interface ApiCommunityOpportunityCommunityOpportunity
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::community-opportunity.community-opportunity'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiFaqItemFaqItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    relatedPrograms: Schema.Attribute.Relation<
      'manyToMany',
      'api::program.program'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactBlockText: Schema.Attribute.Text;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Media<'images'>;
    primaryNavigation: Schema.Attribute.Component<'navigation.nav-item', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiImpactInitiativeImpactInitiative
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::impact-initiative.impact-initiative'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiJobOpeningJobOpening extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    modality: Schema.Attribute.Enumeration<['remoto', 'presencial', 'hibrido']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pageType: Schema.Attribute.Enumeration<
      ['default', 'institutional', 'landing', 'contact', 'community', 'impact']
    > &
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    certifications: Schema.Attribute.Relation<
      ...
      'api::certification.certification'
    >;
    classSizeText: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaLabel: Schema.Attribute.String;
    ctaUrl: Schema.Attribute.String;
    displayOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    durationText: Schema.Attribute.String;
    ...
    modality: Schema.Attribute.Enumeration<['online', 'presencial', 'hibrido']>;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    countryFlag: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::impact-initiative.impact-initiative': ApiImpactInitiativeImpactInitiative;
